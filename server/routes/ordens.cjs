...
const serviceTemplates = {
  limpeza: {
    label: "Limpeza nautica",
    tipo: "Limpeza",
    tarefas: [
      "Registrar foto antes",
      "Conferir estado do casco e conves",
      "Remover objetos soltos e lixo",
      "Lavar casco",
      "Lavar conves",
      "Limpar inox, vidros e acrilicos",
      "Limpar cabine, banheiro e copa",
      "Secar e revisar acabamento",
      "Registrar foto depois",
      "Registrar observacao final",
    ],
  },
  motor: {
    ...
    tarefas: [
      "Registrar foto antes",
      "Diagnostico inicial",
      "Verificar oleo e filtros",
      "Verificar correias, mangueiras e vazamentos",
      "Testar partida e funcionamento",
      "Registrar pecas ou recomendacoes",
      "Registrar foto depois",
    ],
  },
  polimento: {
    ...
    tarefas: [
      "Registrar foto antes",
      "Lavar superficie",
      "Isolar areas sensiveis",
      "Aplicar composto",
      "Polir acabamento",
      "Revisar manchas e brilho",
      "Registrar foto depois",
    ],
  },
  marinharia: {
    ...
    tarefas: [
      "Registrar foto antes",
      "Inspecionar deck, ferragens e guarda-mancebo",
      "Checar cabos, defensas e amarracoes",
      "Ajustar itens soltos",
      "Verificar tampas, escotilhas e drenos",
      "Registrar pendencias encontradas",
      "Registrar foto depois",
    ],
  },
  eletrica: {
    ...
    tarefas: [
      "Registrar foto antes",
      "Desligar alimentacao quando necessario",
      "Inspecionar painel e conexoes",
      "Testar baterias",
      "Testar circuitos e equipamentos",
      "Registrar medicoes",
      "Registrar foto depois",
    ],
  },
  fibra: {
    ...
    tarefas: [
      "Registrar foto antes",
      "Mapear area danificada",
      "Preparar superficie",
      "Aplicar reparo",
      "Lixar e nivelar",
      "Registrar acabamento final",
      "Registrar foto depois",
    ],
  },
  marinheiro: {
    label: "Marinheiro / apoio",
    tipo: "Apoio operacional",
    tarefas: [
      "Confirmar local e horario",
      "Preparar embarcacao",
      "Conferir cabos e defensas",
      "Apoiar manobra ou movimentacao",
      "Registrar ocorrencias",
      "Finalizar checklist de entrega",
    ],
  },
  avulso: {
    ...
    tipo: "Servico avulso",
    tarefas: [
      "Confirmar local/marina",
      "Registrar foto antes, se aplicavel",
      "Executar servico combinado",
      "Registrar observacao do que foi feito",
      "Registrar foto depois, se aplicavel",
      "Marcar OS como concluida",
    ],
  },
};
